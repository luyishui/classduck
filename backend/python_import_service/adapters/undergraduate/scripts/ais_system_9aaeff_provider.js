// Source: 参考文件/aishedule-master/乘方教务/广州中医药大学/provider.js

/**
 * @Author: xiaoxiao
 * @Date: 2022-03-03 12:20:19
 * @LastEditTime: 2022-03-03 13:03:06
...
let req = async (method,url,data)=>{
  ...
  async function scheduleHtmlProvider(iframeContent = "", frameContent = "", dom = document) {//函数名不要动
    ...
    let re = (await req("get","http://jw.gzucm.edu.cn/xsgrkbcx!getKbRq.action?xnxqdm="+xnxqdmValue,null))[0]
    let kcMap = new Map()
    let result = []
    for(key in re){
      let res = {
