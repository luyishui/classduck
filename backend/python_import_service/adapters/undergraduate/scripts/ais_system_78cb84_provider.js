// Source: 参考文件/aishedule-master/正方教务/新正方教务/深圳信息职业技术学院/provider.js

/**
 * @Author: xiaoxiao ddos_ling
 * @Date: 2022-03-01 22:04:08
 * @LastEditTime: 2025-03-06 15:51:56
...
function AIScheduleLoading({
                             titleText = '加载中',
                             contentText = 'loading... (ver:1.4 24-25s2)',
                           } = {}) {
  console.log('start......')
 ...
 * @LastEditTime: 2025-03-06 15:53:34
 * @LastEditors: ddos_ling
 * @Description:
