// Source: 参考文件/aishedule-master/树维/商丘师范学院/provider.js
...
async function scheduleHtmlProvider(
  ...
  let warning = `
  【重要：请使用校园网】
【不使用校园网，可能无法跳转教务(502页面)】
【若能正常跳转到教务(显示为空白上方有一行小字,非503页面),不使用校园网也可】
