// Source: 参考文件/aishedule-master/青果教务/西安翻译学院/provider.js
...
function scheduleHtmlProvider(iframeContent = "", frameContent = "", dom = document) {
    ...
    if(dom.document.getElementById("frame_1") != undefined){
        domm =dom.document.getElementById("frame_1").contentWindow.frames["frmReport"].document
        console.log(11)
    ...
    let tables = domm.getElementsByTagName("table")
    let ht = "";
    ...
    let dJConf={
        ...
        shortRestingTime: 10,
        longRestingTimeBegin: [2,6],
        lunchTime: {begin: 4, time: 1 * 60 + 45},
        dinnerTime: {begin: 8, time: 100},
        abnormalRestingTime:[{begin:9,time:0}],
    }
    let ex1 = getTimes(xJConf,dJConf)

    return JSON.stringify({htm :ht,bz:id,tim:ex1})
