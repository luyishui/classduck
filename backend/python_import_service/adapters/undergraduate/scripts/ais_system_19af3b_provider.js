// Source: 参考文件/aishedule-master/树维/成都信息工程大学/provider.js
...
async function scheduleHtmlProvider(
  ...
  try {
    ...
    sleep(0.5)
    if (location.href.search('authserver/login') != -1) {
...
//     abnormalRestingTime:[]
  ...
  return {
    ...
    sections: getTimes(id === 'hkg'?hkg:lq), // 课程时间表，注意：总长度要和上边配置的节数加和对齐
  }
