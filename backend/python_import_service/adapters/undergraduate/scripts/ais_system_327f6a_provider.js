// Source: 参考文件/aishedule-master/正方教务/新正方教务/安徽建筑大学/Provider.js
...
`
    ...
    let dJConf ={
        ...
        lunchTime  : {begin:5,time:2*60},
        dinnerTime : {begin:9,time:85},
        //abnormalClassTime:[],
        //abnormalRestingTime:[]
    };
    let xJConf =  {
        ...
        shortRestingTime : 5,
        longRestingTimeBegin:[2],
        lunchTime  : {begin:5,time:2*60+15},
        dinnerTime : {begin:9,time:70},
        // abnormalClassTime:[],
        // abnormalRestingTime:[]
    }
