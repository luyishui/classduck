// Source: 参考文件/aishedule-master/正方教务/新正方教务/喀什大学/provider.js

/**
 * @Author: xiaoxiao
 * @Date: 2024-09-07 15：18：01
    ...
    try {
        ...
        try {
            ...
            let html = await request(
                'get',
                null,
                '/jwglxt/kbcx/xskbcxMobile_cxXsKb.html?gnmkdm=' + id
            )
          console.log(html)
  ...
  try {
    ...
    if (res.xnm && !res.xqm) {
      ...
      let times = await timeRequest(
        ...
        '/jwglxt/skxxMobile_cxRsdjc.html'
      )

      let timeJson = {
        totalWeek: 24, // 总周数：[1, 30]之间的整数
        startSemester: '', // 开学时间：2024年9月4日，时间戳，13位长度字符串
