// Source: 参考文件/aishedule-master/强智教务/iframe强智/湖南中医药/Provider.js
...
function scheduleHtmlParser(html) {
    ...
    let Conf = {           //夏季配置
        ...
        lunchTime: {begin: 5, time: 120}, //午休时间:{begin:Number//开始的节数,time:number//时长}:单位：min:可选
        dinnerTime: {begin: 9, time: 110},   //晚餐时间 :{begin:Number//开始的节数,time:number//时长}:单位：min:可选
