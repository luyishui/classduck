// Source: 参考文件/aishedule-master/正方教务/新正方教务/盐城师范学院/provider.js

/**
 * @Author: xiaoxiao
 * @Date: 2022-03-01 22:04:08
 * @LastEditTime: 2022-08-09 23:07:48
    ...
    try {
      ...
      htt = JSON.stringify(
        JSON.parse(
          await request(
            'post',
            'xnm=' + form.xnm.value + '&xqm=' + form.xqm.value,
 ...
 * @Author: xiaoxiao
 * @Date: 2022-03-01 22:04:08
 * @LastEditTime: 2022-03-01 22:53:04
 * @LastEditors: xiaoxiao
 * @Description: 
...
async function scheduleTimer() {
   ...
   let xJConf = {
       ...
       longRestingTime: 20,
       shortRestingTime: 10,
       longRestingTimeBegin: [1,3],
       lunchTime: {begin: 5, time: 2 * 60 + 50},
       dinnerTime: {begin: 9, time: 100},
      abnormalClassTime: [{begin: 1, time: 30}],
