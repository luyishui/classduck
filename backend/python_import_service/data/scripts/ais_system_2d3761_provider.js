// Source: 参考文件/aishedule-master/青果教务/江汉大学/provider.js

/**
 * @Author: xiaoxiao
 * @Date: 2021-11-10 20:00:51
 * @LastEditTime: 2022-08-08 21:44:04
...
async function scheduleHtmlProvider(
  ...
  try {
    ...
    if (dom.document.getElementById('xnxq') && !dom.frames['frame_1']) {
      console.log('fetch showLessonScheduleInfosV14')
    ...
    try {
      console.log('err')
      let info = JSON.parse(
        await request('post', 'gbk', '/jw/common/showYearTerm.action')
      )
      ht = await request(
        'get',
        'gbk',
...
/**
 * @Author: xiaoxiao
 * @Date: 2022-08-08 21:19:11
 * @LastEditTime: 2022-08-08 21:19:13
 * @LastEditors: xiaoxiao
 * @Description:
