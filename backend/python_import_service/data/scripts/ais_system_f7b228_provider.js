// Source: 参考文件/aishedule-master/青果教务/新疆大学/provider.js
...
async function scheduleTimer() {
  ...
  try {
    ...
    // console.log(times)
    // console.log(trs)
    times = times.filter(v=>!!v.startTime.length)
    return {
      ...
      night: times.length - 10, // 晚间课程节数：[0, 10]之间的整数
