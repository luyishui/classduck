// Source: 参考文件/aishedule-master/树维/中原科技学院/provider.js
...
async function scheduleHtmlProvider(
  ...
  if (location.href.search('login\\?service') != -1) {
  ...
  try {
    ...
    sleep(0.5)
    if (!logintag && location.href.search(preUrl + urls.login) == -1) {
...
//   await someAsyncFunc()
  ...
  let xJConf = {
    ...
    dinnerTime : {begin:9,time:80},
//     abnormalClassTime:[],
    // abnormalRestingTime:[{begin:}]
  } 
  let dJConf = {
    courseSum : 11,
    startTime  : '0800',
    ...
    shortRestingTime : 10,
    longRestingTimeBegin:[2,6],
    lunchTime  : {begin:5,time:2*60-35},
    dinnerTime : {begin:9,time:80},
//     abnormalClassTime:[],
    // abnormalRestingTime:[{begin:}]
  } 
