     ...
     // let sections = []
      let timeJson = {
        ...
        sections:  getTimes({ 
            ...
            longRestingTimeBegin : [2,6],//大班空的开始节数 : Array[int] : 可选
            lunchTime  : {begin:4,time:2*60+20}, //午休时间:{begin:Number//开始的节数,time:number//时长}:单位：min:可选
            dinnerTime : {begin:8,time:80},   //晚餐时间 :{begin:Number//开始的节数,time:number//时长}:单位：min:可选
            //abnormalClassTime : [{begin:10,time:35}],    //其他的课程时间 : Array[{},{}] : {begin:Number//开始的节数,time:number//时长} : 单位：min : 可选
