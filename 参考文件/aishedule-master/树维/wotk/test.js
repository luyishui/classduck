...
//     ) {
//       if (
//         firstCourse.sections.sort().toString() ===
//           contractResult[i].sections.sort().toString() &&
//         firstCourse.name === contractResult[i].name &&
//         firstCourse.position === contractResult[i].position &&
//         firstCourse.teacher === contractResult[i].teacher
//       ) {
...
function scheduleHtmlParser(html) {
  ...
  // } catch (e) {
  //   return [{ name: e.message, day: 1, weeks: [1, 2], sections: [1, 2] }]
  // }

  //  return { courseInfos: resolveCourseConflicts(result),sectionTimes:djsects }
  return [
    { name: 'test', position: html, day: 1, weeks: [1, 2], sections: [1, 2] },
  ]
}
